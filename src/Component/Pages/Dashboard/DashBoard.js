...
const DashBoard = () => {
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content drawer-container">
        <h3 className="text-primary text-2xl dashboard-title mt-3">
          Dashboard
        </h3>
        <Outlet></Outlet>
      </div>
      <div className="drawer-side">
        ...
        ></label>
        <ul className="menu p-4 w-64 min-h-full bg-primary text-base-content dashboard-menu">
          {admin ? (
            <>
              <li>
                <Link to="/dashboard">
            ...
            <>
              <li>
                <Link to="/dashboard">
                  <a className="text-center flex items-center">
                    <svg
                      className="me-2"
